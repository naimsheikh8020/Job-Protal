...
const Dashboard = () => {
  ...
  return (
    <div className='min-h-screen'>
        ...
        <div className='shadow py-4'>
            <div className='px-5 flex justify-between items-center'>
                ...
                <div className='flex items-center gap-3'>
                    <p className='max-sm:hidden'>Welcome, Naim</p>
        ...
        <div className='flex'>
            {/* Left Side bar with option to add job, manage jobs, view application  */}
            <div className='inline-block min-h-screen border-r-2 border-gray-200 shadow-sm'>
